...
export default async function handler(req, res) {
  ...
  try {
    ...
    const updateRows = await readSheetCached(CRM_SHEET_ID, `${TABS.CRM_UPDATES}!A:L`, TTL.LIVE)
    ...
    const footageRows = await readSheetCached(ISSUE_SHEET_ID, `${ISSUE_TAB}!A:T`, TTL.ISSUES)
