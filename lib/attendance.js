...
export function lastActivityAt(emp, ctx) {
  ...
  // Enforcement is off unless the floor has turned it on. See
  // heartbeatTrustMinutes() for why this is a decision and not a default.
  return clampClaim(workAt, claimedAt, { trustMinutes: heartbeatTrustMinutes() }).at
}
