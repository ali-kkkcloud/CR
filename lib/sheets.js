...
export async function ensureTab(spreadsheetId, tab, header) {
  ...
  if (titles.includes(tab)) { seen.add(key); return false }
  ...
  // not a failure, it is the outcome they wanted, arrived at by somebody else.
  // Letting it throw would fail a save for the only reason that cannot matter.
  try {
